...
const handleSubmit = async () => {
  console.log(vehicleAttributes,'vehicle attiiririr')
  const images = capturedImages[vehicleType].filter((img) => img);
    ...
    <div className="flex justify-center p-5 min-h-screen">
      <div className="w-full max-w-lg bg-white rounded-lg p-4">
        <div className="text-black w-full py-4 px-6 text-center rounded-t-lg">
          <h1 className="text-xl font-semibold">Upload Images for Vehicle Pickup</h1>
        ...
        {vehicleType && (
          <>
            {/* <p className="my-4 text-center " style={{textDecoration:"underline"}}>Upload Images for Vehicle Pickup</p> */}
              ...
              .map((vehicle, index) => (
                <div
                  ...
                  className={`flex flex-col items-center p-4 rounded-lg shadow-sm cursor-pointer ${
                    selectedVehicle === index ? "border-2 border-orange-500" : ""
                  }`}
                >
                  <img
